  ...
  <div class="container__child signup__form card-body">
    <form method="post">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="password" name="password" size="10" placeholder="Enter password containing maximum 8 characters" id="password" required />
      </div>
